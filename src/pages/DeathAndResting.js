...
const DeathAndResting = () => {
    return (
        ...
        <Section>
            <h2>Dead</h2>
            <p>When a character dies you aren't out of the game. The dead can assist their allies in combat from beyond the grave.</p>
            <p>Once dead, you can choose to strike a feature from your character's sheet at any time and add value to a living player character of your choice. These abilities last until the start of the selected character’s next turn.</p>
